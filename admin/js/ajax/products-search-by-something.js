$(document).ready(function() {
    // select brand
    $("select[name='selectorBrand']").change(function() {
        var brand = this.value;
        var category = $("select[name='selectorCategory']").val();

        $.ajax({
            url: "?m=ajax&a=products-search-by-something",
            dataType: "json",
            type: "POST",
            data: {"searchB": brand, "searchC": category},
        }).done(function(data) {
            if(data != "") {
				var txt = ""; 
    ...
    // select category
    $("select[name='selectorCategory']").change(function() {
        var category = this.value;
        var brand = $("select[name='selectorBrand']").val();
